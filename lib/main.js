...
--     std_str_split_re( r1.abs1, '\s' ) as r2;`);
      ...
      _compile_sql() {
        ...
        sql = {
          ...
          insert_entry: SQL`insert into ${schema}.entries ( word, ipa_raw )
  values ( $word, $ipa_raw );`,
...
/* #cache */        return null;
      ...
      ipa_raw_from_arpabet2(ab) {
        var R, base, base1, cache, i, j, len, len1, letter, level, mark, match, phone, ref, ref1, ref2, ref3, replacement, stress;
