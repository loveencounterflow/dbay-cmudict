...
--     std_str_split_re( r1.abs1, '\s' ) as r2;`);
      ...
      _compile_sql() {
        ...
        sql = {
          ...
          insert_entry: SQL`insert into ${schema}.entries ( word, abs0, abs1, xsampa, ipa )
  ...
  values ( $description, $xs, $ipa, $example );`,
          insert_abs_phones: SQL`insert into ${schema}.abs_phones ( word, lnr, rnr, abs0_phone, abs1_phone, stress )
  values ( $word, $lnr, $rnr, $abs0_phone, $abs1_phone, $stress );`
      ...
      _populate_entries() {
        ...
        this.db(() => {
          var abs0, abs1, ipa, line, ref, word, xsampa;
          ...
          for (line of ref) {
            ...
            if (!((word != null) && word.length > 0 && (abs0 != null) && abs0.length > 0)) {
            ...
            abs0 = abs0.trim();
            abs1 = this._rewrite_arpabet_s(abs0.toLowerCase());
            ipa = this.ipa_from_abs1(abs1);
      ...
      _populate_arpabet_to_ipa() {
        var insert/* #cache */, ipa_by_ab2, line_nr;
        ...
        /* #cache */        guy.props.def(this, 'ipa_by_ab2', {
          enumerable: false,
          value: ipa_by_ab2
        });
/* #cache */        return null;
...
/* #cache */        return null;
      ...
      //   return R.replace /\s/g, ''
        ...
        //---------------------------------------------------------------------------------------------------------
      ipa_from_abs1(abs1) {
        var R, base, i, j, len, len1, letter, level, mark, match, phone, ref, ref1, ref2, ref3, stress;
        R = [];
        ref = abs1.split('\x20');
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if ((match = phone.match(/^(?<base>\D+)(?<level>\d*)$/)) != null) {
            ...
            ref2 = Array.from((ref1 = this.ipa_by_ab2[base]) != null ? ref1 : '█');
            ...
            R.push((ref3 = this.ipa_by_ab2[phone]) != null ? ref3 : '█');
          }
        }
        // debug '^444^', { mark, base, }
        // return mark + base
